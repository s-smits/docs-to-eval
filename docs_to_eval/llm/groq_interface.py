...
class GroqConfig:
    ...
    model: str = "llama-3.1-8b-instant"  # Default to Llama 3.1 8B Instant
    max_tokens: int = 1024
...
class GroqInterface(BaseLLMInterface):
    ...
    # Available Groq models with their capabilities (updated September 2025)
    AVAILABLE_MODELS = {
        ...
        "meta-llama/llama-guard-4-12b": {
            ...
            "capabilities": ["safety_moderation", "content_filtering", "factual_qa"],
            "speed": "fast"
        },
        "openai/gpt-oss-120b": {
...
async def test_groq_connection(api_key: Optional[str] = None, model: str = "llama-3.1-8b-instant") -> Dict[str, Any]:
    """
