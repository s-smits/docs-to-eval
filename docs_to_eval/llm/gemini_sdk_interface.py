...
class GeminiConfig:
    ...
    model: str = "gemini-1.5-flash-latest"  # Default to Flash for speed
...
class GeminiSDKInterface(BaseLLMInterface):
    ...
    AVAILABLE_MODELS = {
        ...
        "gemini-1.0-pro": {
            ...
            "capabilities": ["reasoning", "factual_qa", "mathematical", "creative_writing"],
            "speed": "medium",
            "cost": "medium"
        },
        "gemini-pro": {
...
if __name__ == "__main__":
    ...
    async def demo():
        ...
        if "gemini-1.5-pro-latest" in [m['model_id'] for m in available_models]:
            interface.switch_model("gemini-1.5-pro-latest")
